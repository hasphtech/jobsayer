...
const ROLE_SAMPLES: SampleMeta[] = [
  {
    label: "Software Engineer", role: "Backend · 4 yrs", emoji: "ti-device-laptop", mode: "experienced",
    data: SAMPLE,
  },
  {
    label: "Fresher / Student", role: "Computer Science · 2025", emoji: "ti-school", mode: "fresher",
    data: {
  ...
  {
    label: "Data Scientist", role: "ML / Analytics · 3 yrs", emoji: "ti-chart-bar", mode: "experienced",
    data: {
  ...
  {
    label: "Product Manager", role: "SaaS / 5 yrs", emoji: "ti-package", mode: "experienced",
    data: {
  ...
  {
    label: "Marketing Manager", role: "Growth / 4 yrs", emoji: "ti-speakerphone", mode: "experienced",
    data: {
  ...
  {
    label: "UX Designer", role: "Product Design · 3 yrs", emoji: "ti-palette", mode: "experienced",
    data: {
  ...
  {
    label: "Finance / CA", role: "Chartered Accountant · 4 yrs", emoji: "ti-trending-up", mode: "experienced",
    data: {
  ...
  {
    label: "Sales Executive", role: "B2B SaaS · 3 yrs", emoji: "ti-handshake", mode: "experienced",
    data: {
  ...
  {
    label: "HR Manager", role: "HRBP · Talent · 6 yrs", emoji: "ti-users", mode: "experienced",
    data: {
    ...
    <div style={{ marginTop: 6, padding: "11px 14px", background: "var(--bg)", borderWidth: 1, borderStyle: "solid", borderColor: "var(--border)", borderRadius: 10 }}>
      ...
      {hints?.map((h, i) => (
        <div key={i} style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 11, color: "var(--text3)", marginTop: 4 }}>
          <span style={{ color, fontWeight: 700 }}><i className="ti ti-arrow-right"/></span> {h}
        </div>
      ))}
      {score === max && (
...
export default function BuilderPage() {
  ...
  function applyCrop() {
    ...
    // Step 2: objectPosition percentage <i className="ti ti-arrow-right"/> source origin in natural pixels
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", height: "100dvh", background: "var(--bg)", overflow: "hidden" }}>
        ...
        <header style={{ height: 56, background: "var(--nav-bg)", backdropFilter: "blur(16px)", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", padding: "0 14px", gap: 10, flexShrink: 0, zIndex: 10 }}>
          ...
          {/* ATS mini bar — clickable <i className="ti ti-arrow-right"/> ATS step */}
        ...
        <div style={{ padding: "10px 14px", borderTop: "1px solid var(--border)", background: "var(--surface)", display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
          ...
          <div style={{ display: "flex", gap: 7, alignItems: "center" }}>
            ...
            <button onClick={() => setShowPreview(true)}
              ...
              <i className="ti ti-eye" style={{marginRight:4}}/>Preview
            </button>
            {!isQuickStep && (
              isLastMain
              ...
              <div style={{ overflowY: "auto", flex: 1 }}>
                {loadingSaves ? (
                  ...
                  <div style={{ padding: "28px 18px", textAlign: "center" }}>
                    <div style={{ fontSize: 28, marginBottom: 10 }}><i className="ti ti-file-text"/></div>
          ...
          {customizeTab === "order" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ padding: "12px 14px", background: "var(--accdim)", borderWidth: 1, borderStyle: "solid", borderColor: "var(--accborder)", borderRadius: 10, fontSize: 11, color: "var(--accent)" }}>
                <i className="ti ti-bulb"/> Section order updates the resume preview instantly.
              </div>
            </div>
          )}
      ...
      return (
        <div style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: "100%" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, background: pageCount > 1 ? "rgba(234,179,8,.07)" : "var(--bg)", borderWidth: 1.5, borderStyle: "solid", borderColor: pageCount > 1 ? "var(--warn)" : "var(--border)", borderRadius: 12, padding: "14px 16px" }}>
            <span style={{ fontSize: 28, lineHeight: 1, color: pageCount > 1 ? "var(--warn)" : "var(--text3)" }}><i className="ti ti-file-text"/></span>
            <div>
                ...
                <button key={s.label} onClick={() => { const key = MAIN_STEPS[s.stepIdx]?.key ?? null; setStep(s.stepIdx); setActiveSection(key); }}
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {s.hints && s.hints.length > 0 && (
                      <div style={{ fontSize: 10, color: "var(--text3)", marginTop: 4 }}><i className="ti ti-arrow-right"/> {s.hints[0]}</div>
                    )}
                  </div>
          ...
          {liImportOpen && (
            <div style={{ marginTop: 12, display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ padding: "10px 12px", background: "var(--surface2)", borderRadius: 8, borderWidth: 1, borderStyle: "solid", borderColor: "var(--border)" }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: "var(--text2)", marginBottom: 6 }}><i className="ti ti-layout-list"/> Auto-fill from LinkedIn profile</div>
                <ol style={{ margin: 0, paddingLeft: 16, display: "flex", flexDirection: "column", gap: 4 }}>
                  {[
                    "Open your LinkedIn profile",
                    "Click More <i className="ti ti-arrow-right"/> Save to PDF",
              ...
              <div style={{ background: "var(--surface)", borderRadius: 16, padding: 24, width: "100%", maxWidth: 380, display: "flex", flexDirection: "column" as const, gap: 16, boxShadow: "0 20px 60px rgba(0,0,0,.5)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" as const, gap: 5 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <span style={{ fontSize: 11, fontWeight: 700, color: "var(--text2)" }}><i className="ti ti-search"/> Zoom</span>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: "100%" }}>
        ...
        {mode === "fresher" && (
          <div style={{ padding: "10px 14px", background: "var(--accdim)", borderWidth: 1, borderStyle: "solid", borderColor: "var(--accborder)", borderRadius: 10, fontSize: 11, color: "var(--accent)", fontWeight: 600 }}>
            <i className="ti ti-bulb"/> No full-time experience yet? Add internships, college projects with industry tie-ups, or freelance gigs.
          </div>
        )}
        ...
        {data.work.length === 1 && !data.work[0].company && !data.work[0].role && (
          <div style={{ padding: "12px 14px", background: "var(--surface2)", borderWidth: 1, borderStyle: "dashed", borderColor: "var(--accborder)", borderRadius: 10, display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ fontSize: 10, fontWeight: 700, color: "var(--accent)", textTransform: "uppercase" as const, letterSpacing: ".5px" }}><i className="ti ti-bulb"/> Example</div>
            <div>
              ...
              {openSuggestions === i && getSuggestions(w.role).length > 0 && (
                <div style={{ background: "rgba(234,179,8,.07)", borderWidth: 1, borderStyle: "solid", borderColor: "rgba(234,179,8,.2)", borderRadius: 9, padding: "10px 12px", display: "flex", flexDirection: "column", gap: 5 }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: "var(--warn)", textTransform: "uppercase" as const, letterSpacing: ".5px", marginBottom: 2 }}>
                    <i className="ti ti-bulb"/> Suggestions for "{w.role}" — click to add
                  </div>
    ...
    if (key === "projects") return (
      <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: "100%" }}>
        ...
        {(data.projects ?? []).length === 0 && (
          <div style={{ padding: "12px 14px", background: "var(--surface2)", borderWidth: 1, borderStyle: "dashed", borderColor: "var(--accborder)", borderRadius: 10, display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ fontSize: 10, fontWeight: 700, color: "var(--accent)", textTransform: "uppercase" as const, letterSpacing: ".5px" }}><i className="ti ti-bulb"/> Example project</div>
            <div>
    ...
    if (key === "__declaration") return (
      <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: "100%" }}>
        ...
        <div style={{ padding: "10px 14px", background: "var(--accdim)", border: "1px solid var(--accborder)", borderRadius: 9, fontSize: 12, color: "var(--text2)", lineHeight: 1.6 }}>
          <i className="ti ti-bulb"/> Most Indian companies expect a declaration. It adds credibility and is required by some recruiters.
        </div>
        <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              {jdResult.missing.length > 0 && (
                <button onClick={() => setStep(4)}
                  ...
                  Edit Skills section <i className="ti ti-arrow-right"/>
                </button>
              )}
            </div>
          )}
    ...
    if (step === STEP_REORDER) {
      ...
      return (
        <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: "100%" }}>
          ...
          <div style={{ padding: "12px 14px", background: "var(--accdim)", borderWidth: 1, borderStyle: "solid", borderColor: "var(--accborder)", borderRadius: 10, fontSize: 11, color: "var(--accent)" }}>
            <i className="ti ti-bulb"/> Drag rows to reorder — the resume preview updates instantly.
          </div>
        </div>
      );
    }
    ...
    <AppShell actions={builderActions} contentFill aiPanel={false}>
      ...
      {showScoreCta && (
        <div style={{
          ...
          <div style={{ fontSize: 28 }}><i className="ti ti-confetti"/></div>
          <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            <a href="/score" style={{ padding: "8px 14px", background: "var(--accent)", borderRadius: 8, color: "#fff", fontSize: 12, fontWeight: 700, textDecoration: "none", whiteSpace: "nowrap" }}>View Score <i className="ti ti-arrow-right"/></a>
            <a href="/jobs" style={{ padding: "8px 14px", background: "var(--accdim)", border: "1px solid var(--accborder)", borderRadius: 8, color: "var(--accent)", fontSize: 12, fontWeight: 700, textDecoration: "none", whiteSpace: "nowrap" }}>Jobs <i className="ti ti-arrow-right"/></a>
          ...
          {leftTab === "edit" && (
            <div style={{ flex: 1, overflowY: "auto", paddingTop: 0, display: "flex", flexDirection: "column" as const }}>
              ...
              {step === STEP_ATS ? (
                <div style={{ flex: 1, padding: "0 12px 20px" }}>
                  <button
                    ...
                    <i className="ti ti-arrow-left"/> Back to editing
                  </button>
                  {renderStepContent()}
                </div>
              ) : (<>
                      ...
                      {currentSaveId && (
                        <div style={{ padding: "6px 12px 10px", borderTop: "1px solid var(--border)" }}>
                          <button onClick={() => { handleLoadVersions(); setSavesOpen(false); }}
                            ...
                            <i className="ti ti-history" style={{marginRight:4}}/>Version history {versionCount > 0 ? `(${Math.min(versionCount, 10)})` : ""}
                          </button>
                        </div>
                      )}
                    </div>
                ...
                <div style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(0,0,0,.6)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}
                  ...
                  <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 16, padding: "24px", width: "100%", maxWidth: 420, maxHeight: "70vh", overflowY: "auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                      <div style={{ fontSize: 15, fontWeight: 700 }}><i className="ti ti-history" style={{marginRight:4}}/>Version History</div>
              ...
              <div style={{ padding: "0 12px 10px" }}>
                ...
                {ats.tips.length > 0 && (
                  <div style={{ marginTop: 6, fontSize: 10, color: "var(--text3)" }}><i className="ti ti-arrow-right"/> {ats.tips[0]}</div>
                )}
              </div>
              ...
              {orderedIndices.map(idx => {
                ...
                const ICONS: Record<string, string> = { profile: "ti-user", summary: "ti-note", work: "ti-briefcase", edu: "ti-school", skills: "ti-bolt", projects: "ti-rocket", certifications: "ti-trophy", languages: "ti-world", awards: "ti-medal", interests: "ti-target", references: "ti-user" };
                        ...
                        <div style={{ height: 88, background: active ? "var(--accdim)" : "var(--surface2)", position: "relative" as const, overflow: "hidden" }}>
                          ...
                          {isRec && (
                            <div style={{ position: "absolute" as const, top: 5, left: 5, background: "var(--warn)", color: "#000", fontSize: 9, fontWeight: 800, padding: "1px 5px", borderRadius: 4, letterSpacing: ".3px" }}>
                              <i className="ti ti-star"/> FOR YOU
                            </div>
                          )}
                ...
                <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  {jdResult.missing.length > 0 && (
                    <div style={{ padding: "10px 12px", background: "var(--accdim)", borderWidth: 1, borderStyle: "solid", borderColor: "var(--accborder)", borderRadius: 8, fontSize: 11, color: "var(--accent)", lineHeight: 1.6 }}>
                      <i className="ti ti-bulb"/> Add missing keywords to your Skills or Summary to improve your score.
                    </div>
                  )}
                </div>
              )}
            ...
            {!user && (
              <div style={{ position: "sticky", bottom: 0, width: "100%", background: "linear-gradient(to top, #9ca3af 55%, transparent)", padding: "28px 0 16px", display: "flex", flexDirection: "column", alignItems: "center", gap: 10, pointerEvents: "none" as const }}>
                <div style={{ pointerEvents: "auto" as const, padding: "16px 24px", background: "var(--surface)", borderRadius: 14, borderWidth: 1.5, borderStyle: "solid", borderColor: "var(--border)", boxShadow: "0 8px 32px rgba(0,0,0,.3)", textAlign: "center" as const, maxWidth: 320 }}>
                  <div style={{ fontSize: 22, marginBottom: 6 }}><i className="ti ti-lock"/></div>
