...
export default function UpgradeSuccessPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--surface)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, textAlign: "center" }}>
      {status === "verifying" && (
        <>
          <div style={{ fontSize: 48, marginBottom: 16 }}><i className="ti ti-hourglass"/></div>
      ...
      {status === "success" && (
        <>
          <div style={{ fontSize: 64, marginBottom: 16 }}><i className="ti ti-confetti"/></div>
      ...
      {status === "error" && (
        <>
          <div style={{ fontSize: 48, marginBottom: 16 }}><i className="ti ti-alert-triangle"/></div>
